...
#define ZX_UPC_EAN_MAX_AVG_VARIANCE (int)(ZX_ONED_PATTERN_MATCH_RESULT_SCALE_FACTOR * 0.48f)
#define ZX_UPC_EAN_MAX_INDIVIDUAL_VARIANCE (int)(ZX_ONED_PATTERN_MATCH_RESULT_SCALE_FACTOR * 0.7f)
